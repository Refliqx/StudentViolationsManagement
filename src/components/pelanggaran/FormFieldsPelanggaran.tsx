                    ...
                    {searchQuery && !form.siswa_id && (
                        <div className="max-h-48 overflow-y-auto border rounded-md bg-white shadow-lg">
                            {filteredSiswa.length > 0 ? (
                                ...
                                <div className="text-gray-500 px-4 py-3 text-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2 col-span-1 md:col-span-2">
                        ...
                        <Input
                            ...
                            placeholder="Tindakan yang diambil (sanksi formal)"
                            className="w-full"
                            required
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Catatan tambahan pembinaan"
                            className="w-full"
                        />
                    </div>
                </div>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
                            ...
                            <label htmlFor="file-upload" className="cursor-pointer">
                                ...
                                <p className="text-sm font-medium text-gray-700 mb-1">
                                    Klik untuk upload foto/file bukti
                                </p>
                                <p className="text-xs text-gray-500">
                                    Pilih foto atau file apa saja (max 5MB)
                                </p>
                            </label>
                        </div>
                    )}
